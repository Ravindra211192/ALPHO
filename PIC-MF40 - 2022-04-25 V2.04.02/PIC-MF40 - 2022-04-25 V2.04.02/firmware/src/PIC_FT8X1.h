...
/** PIC_FT8X1.h
  ...
  @Description
    FTDI EVE FT8X1 header file
 */
/* ************************************************************************** */

#ifndef _PIC_FT8X1_H                // Guard against multiple inclusion
#define _PIC_FT8X1_H

//#include "PIC32.h"
//#include "system_definitions.h"

// Enable one and only one of the following Display-Types
//#define RIVERDI_43_480x272        // uses FT801
//#define RIVERDI_50_800x480        // uses FT813 with 5.0 Inch Display (or FT812, without touch)
#define RIVERDI_70_800x480          // uses FT813 with 7.0 Inch Display
//#define RIVERDI_50_70_800x480     // uses FT813 with 5.0 OR 7.0 Inch Display (TypeCodeInputs & 4)

#ifndef RIVERDI_43_480x272
    #define FT_81X_ENABLE           // enable if FT_81X is used
    #ifdef RIVERDI_50_800x480
        #define INCH   50
    #else
        #ifdef RIVERDI_70_800x480
            #define INCH   70
        #else
            #ifdef RIVERDI_50_70_800x480
                #define INCH   ((TypeCodeInputs & 4) ? 70 : 50)
            #else
                Error
            #endif
        #endif
...
typedef int32   ft_int32_t;
typedef uint32  ft_uint32_t;
typedef int16   ft_int16_t;
typedef uint16  ft_uint16_t;
typedef char    ft_char8_t; 
typedef uchar   ft_uint8_t; 


#define HC_ACTIVE   0x00
#define HC_STANDBY  0x41
#define HC_SLEEP    0x42
#define HC_PWRDOWN  0x50
#define HC_CLKEXT   0x44
#define HC_CLKINT   0x48
#define HC_CLK48M   0x62
#define HC_CLK36M   0x61
#define HC_CORERST  0x68
