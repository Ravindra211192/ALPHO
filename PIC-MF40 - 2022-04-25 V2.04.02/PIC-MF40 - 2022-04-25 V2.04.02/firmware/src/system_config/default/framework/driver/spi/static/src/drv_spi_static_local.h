...
int32_t DRV_SPI1_ISRMasterRM8BitTasks ( struct DRV_SPI_OBJ * dObj );
int32_t DRV_SPI1_ISRErrorTasks(struct DRV_SPI_OBJ * dObj);
int32_t DRV_SPI1_MasterRMSend8BitISR( struct DRV_SPI_OBJ * dObj );
int32_t DRV_SPI1_MasterRMReceive8BitISR( struct DRV_SPI_OBJ * dObj );
// DOM-IGNORE-BEGIN
#ifdef __cplusplus
}
#endif
